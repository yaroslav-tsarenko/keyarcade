...
export const LEGAL_DOCS: Record<string, LegalDoc> = {
  terms: {
    ...
    updated: UPDATED,
    intro:
      "These Terms and Conditions govern access to keyarcade.com and purchases of game keys, software activation codes, subscription codes, gift cards, wallet top-ups and other digital products supplied by COMPANY NAME OÜ.",
    sections: [
      {
        heading: "1. About Us",
        body: [
      ...
      },
      {
        ...
        body: [
          ...
          "COMPANY NAME does not control Publisher platform availability, third-party account suspensions, online servers, future hardware or software changes, or third-party subscription renewal settings. This does not exclude our responsibility to supply a Product Code that conforms to its description and applicable mandatory requirements at the time of supply.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "Your bank or card issuer may apply its own exchange rate, foreign-transaction charge or cross-border processing fee. These charges are not controlled by COMPANY NAME.",
          "The total amount payable to COMPANY NAME will be displayed before the Order is submitted. COMPANY NAME OÜ is not currently registered for value added tax and does not have a VAT registration number. We will not state a VAT registration number or separately identify an amount as VAT unless our applicable tax status changes. Any charge that we are legally required to collect will be disclosed before submission.",
        ],
      },
      {
        heading: "10. Payment",
        body: [
          ...
          "Payment is processed through authorised payment service infrastructure. COMPANY NAME does not normally receive or store the complete card number or card security code processed directly by the payment service provider.",
      ...
      },
      {
        ...
        body: [
          ...
          "We are not responsible for redemption by another person after secure delivery where disclosure resulted from the Customer sharing the code, losing control of email or Account access, or failing to protect credentials. This does not apply where disclosure resulted from a security failure for which COMPANY NAME is legally responsible.",
        ],
      },
      {
        ...
        body: [
          ...
          "Subscription Products provide access for the period, platform and region shown. A Publisher may require an eligible account or payment method and may operate its own renewal settings. Unless clearly disclosed and separately accepted, purchasing from COMPANY NAME does not authorise COMPANY NAME to charge you automatically for renewal.",
          "Gift cards and wallet top-ups are issued for the platform, denomination, currency and region shown. The Publisher operates the third-party wallet or stored-value account; COMPANY NAME remains responsible for supplying a Product Code conforming to its description.",
        ],
      },
      {
        ...
        body: [
          {
            list: [
              ...
              "infringement of the rights of COMPANY NAME, a Publisher or another person.",
            ],
          },
        ],
      },
      {
        ...
        body: [
          "The Website’s original text, design, graphics, software, databases and branding are owned by or licensed to COMPANY NAME and protected by applicable intellectual-property law.",
    ...
    sections: [
      {
        heading: "1. Scope",
        body: [
          "This Policy applies to digital Products sold by COMPANY NAME OÜ through keyarcade.com, including games, software, subscriptions, gift cards and wallet top-ups.",
      ...
      },
      {
        ...
        body: [
          "Depending on applicable law and the circumstances, COMPANY NAME may provide activation assistance, replacement, correction, a proportionate price reduction, cancellation or refund.",
  ...
  cookies: {
    ...
    updated: UPDATED,
    intro:
      "This Cookie Policy explains how COMPANY NAME OÜ uses cookies and similar technologies on keyarcade.com and how visitors can control optional technologies.",
    sections: [
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "COMPANY NAME is not responsible for delay caused solely by an incorrectly entered email address, an over-quota mailbox, customer-side filtering or loss of access, but will provide reasonable assistance after identity and Order details are verified.",
        ],
      },
      {
  ...
  complaints: {
    ...
    updated: UPDATED,
    intro:
      "This Policy explains how Customers can submit a complaint and how COMPANY NAME OÜ handles unresolved consumer disputes.",
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          ...
          "The Customer will not be required to obtain evidence that is impossible or unreasonably burdensome where COMPANY NAME or its fulfilment provider can reasonably verify the relevant fact.",
        ],
      },
      {
        heading: "4. Response Time",
        body: [
          "For consumer complaints governed by Estonian law, COMPANY NAME will provide a written response no later than 15 days after receiving the complaint.",
      ...
      },
      {
        ...
        body: [
          "If a dispute between a consumer resident in Estonia and COMPANY NAME OÜ cannot be resolved directly, the consumer may apply to the independent Estonian Consumer Disputes Committee.",
  ...
  "acceptable-use": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Customers must not reproduce, publish, sell or distribute Product Codes unlawfully, remove proprietary notices, misrepresent affiliation with COMPANY NAME or a Publisher, or use Website materials in a manner infringing intellectual-property rights.",
        ],
      },
      {
        heading: "8. Enforcement Measures",
        body: [
          "Where reasonably supported by the circumstances, COMPANY NAME may delay or refuse an Order, request proportionate verification, restrict purchasing, suspend an Account, cancel an affected Order, preserve evidence or report suspected unlawful activity.",
      ...
      },
      {
        ...
        body: [
          "If COMPANY NAME cancels an unfulfilled Order under this Policy after payment has been collected, the amount due will be returned to the original payment method unless the funds are lawfully frozen, reversed or otherwise subject to a binding restriction.",
        ],
      },
      {
  ...
  accessibility: {
    ...
    updated: UPDATED,
    intro:
      "COMPANY NAME OÜ aims to make keyarcade.com and the associated purchasing journey usable by as many people as reasonably possible, including people who use assistive technologies.",
    sections: [
      {
